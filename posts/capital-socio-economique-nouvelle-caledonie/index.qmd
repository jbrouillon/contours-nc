...
image: "../../data/cartes/capital socio-economique/capital_acp_lisse_nc.png"
...
map_nc_path <- file.path(map_dir, "capital_acp_lisse_nc.png")
map_noumea_locale_path <- file.path(map_dir, "capital_acp_lisse_noumea_echelle_locale.png")
...
Lorsque 2 variables sont trop corrélées entre elles, le choix est fait de n'en garder qu'une seule car inclure les 2 reviendrait à donner un poids trop important à une même dimension.
...
```{r carte-capital-nc, fig.cap="Indice de capital socio-économique lissé - Nouvelle-Calédonie.", out.width="100%"}
render_optional_map(
  map_nc_path,
...
```{r carte-capital-noumea-locale, fig.cap="Indice de capital socio-économique lissé - Nouméa, échelle locale.", out.width="100%"}
render_optional_map(
