...
image: "../../images/previews/regroupement-bureaux-vote-noumea.jpg"
image-alt: "Carte des temps de trajet à pied vers le bureau de vote le plus proche à Nouméa"
...
- Dans le scénario à 9 centres regroupés, le temps moyen estimé passe de 13,3 à 21,8 minutes.
- La part de population située à plus de 30 minutes à pied passe de 5,2 % à 17,2 %.
- Les effets ne sont pas homogènes : certains quartiers cumulent hausse des temps de marche et forte part de ménages sans véhicule.
- Les résultats mesurent une accessibilité potentielle, pas les déplacements réels de chaque électeur.
:::
...
Cette note propose une première estimation spatiale des effets potentiels du regroupement des bureaux de vote à Nouméa à partir d’un calcul de temps de trajet piétons sur réseau routier. Trois configurations sont comparées :

-   la configuration habituelle des bureaux de vote ;
-   un scénario à 8 centres regroupés ;
-   un scénario à 9 centres regroupés.
...
-   les résultats électoraux par bureau, pour isoler les bureaux de Nouméa et leurs coordonnées ; les bureaux de vote réputés dégradés à la rentrée 2025 et possiblement affectés pour une réouverture (Gustave LODS et PERVENCHES) ont été retirés du calcul ;
...
```{r temps-bureaux-complets, fig.cap="Temps de trajet à pied (5 km/h) vers le bureau de vote le plus proche (configuration de référence, 54 bureaux retenus)."}
knitr::include_graphics(data_path("cartes", "municipales 2026", "temps trajet nouméa bureaux complets.webp"))

```

```{r temps-bureaux-8, fig.cap="Temps de trajet à pied (5 km/h) vers le centre de vote le plus proche (configuration à 8 centres regroupés)."}
knitr::include_graphics(data_path("cartes", "municipales 2026", "temps trajet nouméa bureaux regroupés.webp"))

```

```{r temps-bureaux-9, fig.cap="Temps de trajet à pied (5 km/h) vers le centre de vote le plus proche (configuration à 9 centres regroupés)."}
knitr::include_graphics(data_path("cartes", "municipales 2026", "temps trajet nouméa bureaux regroupés sans koe kara.webp"))
...
```{r menages-sans-vehicules, fig.cap="Part des ménages sans véhicule à Nouméa, par IRIS, d'après le RGP 2019."}
knitr::include_graphics(data_path("cartes", "municipales 2026", "menages sans véhicules noumea 2019.webp"))
...
## Accessibilité et abstention

La carte de l'abstention au 1er tour permet de donner un aperçu des zones les plus abstentionnistes et de leur correspondance avec les temps de trajet les plus importants. Cependant, il n'est pas possible d'établir de corrélation directe étant donné que les causes de l'abstention sont multifactorielles. Une modélisation statistique combinant diverses variables socio-démographiques et électorales serait nécessaire pour tenter d'isoler les effets propres de la distance, cela resterait cependant sujet à incertitudes.

```{r abstention-2026, fig.cap="Abstention au premier tour des municipales 2026 par bureau de vote à Nouméa."}
knitr::include_graphics(data_path("cartes", "municipales 2026", "abstention nouméa 2026 bureaux complets.webp"))
...
Cette première estimation montre que le regroupement des bureaux de vote ne produit pas seulement un déplacement administratif des lieux de vote : il modifie sensiblement les conditions concrètes d'accès au scrutin. À Nouméa, le passage des bureaux habituels aux centres regroupés augmente le temps moyen d'accès piéton, qui passe de `r fmt_min(scenario_stats$moyenne[scenario_stats$scenario == "Bureaux de vote habituels"])` dans la configuration de référence à `r fmt_min(scenario_stats$moyenne[scenario_stats$scenario == "9 centres regroupés"])` dans le scénario à 9 centres.

L'effet le plus important concerne toutefois les situations d'éloignement. La part de population située à plus de 30 minutes à pied d'un centre de vote passe de `r fmt_pct(scenario_stats$part_pop_plus_30[scenario_stats$scenario == "Bureaux de vote habituels"])` avec les bureaux habituels à `r fmt_pct(scenario_stats$part_pop_plus_30[scenario_stats$scenario == "9 centres regroupés"])` dans le scénario à 9 centres. L'ajout d'un neuvième centre améliore une partie de la situation par rapport au scénario à 8 centres, notamment dans le nord de Nouméa, mais il ne rétablit pas la proximité offerte par le maillage habituel des bureaux.
...
<div class="article-related-grid">
  <a class="article-related-link" href="../participation-accessibilite-bureaux-noumea/">
    <span class="article-related-kicker">Suite du débat</span>
    <span class="article-related-title">Le débat est-il vraiment clos ?</span>
    <span class="article-related-note">La participation municipale 2026 relue à partir des mêmes enjeux d'accessibilité.</span>
  </a>
  <a class="article-related-link" href="../capital-socio-economique-nouvelle-caledonie/">
    ...
    <span class="article-related-note">Un indice territorial pour replacer la motorisation et l'accès aux ressources dans leur contexte social.</span>
  </a>
  <a class="article-related-link" href="../provinciales-2019-geographies-electorales/">
    <span class="article-related-kicker">Géographie électorale</span>
    <span class="article-related-title">Retour sur les provinciales 2019</span>
    <span class="article-related-note">Une autre lecture des territoires électoraux, à l'échelle des communes et quartiers.</span>
  </a>
</div>
</section>
```
