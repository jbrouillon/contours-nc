...
image: "../../data/cartes/municipales 2026/temps trajet nouméa bureaux complets.png"
...
```{r temps-bureaux-complets, fig.cap="Temps de trajet à pied (5km/h) vers le bureau de vote le plus proche (configuration 54 bureaux)"}
knitr::include_graphics(data_path("cartes", "municipales 2026", "temps trajet nouméa bureaux complets.png"))

```

```{r temps-bureaux-8, fig.cap="Temps de trajet à pied (5km/h) vers le bureau de vote le plus proche (configuration 8 bureaux regroupés)"}
knitr::include_graphics(data_path("cartes", "municipales 2026", "temps trajet nouméa bureaux regroupés.png"))

```

```{r temps-bureaux-9, fig.cap="Temps de trajet à pied (5km/h) vers le bureau de vote le plus proche (configuration 9 bureaux regroupés)"}
knitr::include_graphics(data_path("cartes", "municipales 2026", "temps trajet nouméa bureaux regroupés sans koe kara.png"))
...
```{r menages-sans-vehicules, fig.cap="Temps de trajet à pied (5km/h) vers le bureau de vote le plus proche (configuration 54 bureaux)"}
knitr::include_graphics(data_path("cartes", "municipales 2026", "menages sans véhicules noumea 2019.png"))
...
```{r abstention-2026, fig.cap="Temps de trajet à pied (5km/h) vers le bureau de vote le plus proche (configuration 54 bureaux)"}
knitr::include_graphics(data_path("cartes", "municipales 2026", "abstention nouméa 2026 bureaux complets.png"))
